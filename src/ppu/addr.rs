...
impl AddressRegister {
    ...
    pub fn get_inner_tile_y_offset(&self) -> usize {
        ((self.v & 0b111_0000_0000_0000) >> 12) as usize
    }

    pub fn set_inner_tile_y_offset(&mut self, data: u8) {
        let l = ((data % 8) as u16) << 12;
        self.v = (self.v & !0b111_0000_0000_0000) | l;
    }

    pub fn get_tile_x(&self) -> usize {
        (self.v & 0b000_0000_0001_1111) as usize
    }

    pub fn get_tile_y(&self) -> usize {
        ((self.v & 0b000_0011_1110_0000) >> 5) as usize
    }

    pub fn set_tile_y(&mut self, data: u8) {
        let l = ((data % 30) as u16) << 5;
        self.v = (self.v & !0b000_0011_1110_0000) | l;
    }

    pub fn get_name_table(&self) -> usize {
        ((self.v & 0b1100_0000_0000) >> 10) as usize
    }

    pub fn vertical_name_table_overflow(&mut self) {
        self.v ^= 0b10_00000_00000;
    }

    pub fn horizontal_name_table_overflow(&mut self) {
        self.v ^= 0b01_00000_00000;
    }

    pub fn load_x_from(&mut self, t: &TRegister) {
        let tmp = (self.v & !0b100_0001_1111) | (t.data & 0b100_0001_1111);
        self.v = tmp;
    }

    pub fn load_y_from(&mut self, t: &TRegister) {
        let tmp = (self.v & !0b0111_0011_1110_0000) | (t.data & 0b111_1011_1110_0000);
        self.v = tmp;
    }
}
...
pub mod test {
    ...
    fn test_load_x_from() {
        ...
        a.load_x_from(&t);
        assert_eq!(a.v, 0b11111011_11111001)
    }
    ...
    fn test_load_y_from() {
        ...
        t.data = 0b10100010_01011001;
        a.load_y_from(&t);
        assert_eq!(a.v, 0b10101110_01011111)
    }
}
