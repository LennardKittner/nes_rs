...
fn test_adc_carry() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x69, 0x00, 0x00], 0x1000);
    cpu.reset();
...
fn test_bcs_pos() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xB0, 0b0001_0010], 0x1000);
    cpu.reset();
    cpu.set_flag(Flags::Carry);
...
fn test_beq_pos() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xF0, 0b0001_0010], 0x1000);
    cpu.reset();
...
fn test_bmi_pos() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x30, 0b0001_0010], 0x1000);
    cpu.reset();
...
fn test_bvs_pos() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x70, 0b0001_0010], 0x1000);
    cpu.reset();
...
fn test_bit_zero() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x24, 0b0001_0010], 0x1000);
    cpu.reset();
...
// BRK will set InterruptDisabled before the program exits
#[test]
fn test_cli() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
...
fn test_dec_zero() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xD6, 0x11, 0x00], 0x1000);
    cpu.reset();
    cpu.register_x = 0x23;
...
fn test_inc_neg() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xF6, 0x11, 0x00], 0x1000);
    cpu.reset();
    cpu.register_x = 0x23;
...
fn test_jmp_indirect() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x6C, 0x20, 0x01, 0x00], 0x1000);
    cpu.reset();
...
fn test_ldx_zero_page_y() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xB6, 0x3A, 0x00], 0x1000);
    cpu.reset();
    cpu.register_y = 0x41;
...
fn test_ldy_zero_absolute_x() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xBC, 0x45, 0x12, 0x00], 0x1000);
    cpu.reset();
    cpu.register_x = 0x33;
...
fn test_rol_carry_absolute() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x2E, 0x99, 0x15, 0x00], 0x1000);
    cpu.reset();
...
fn test_ror_carry_neg_absolute() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x6E, 0x99, 0x15, 0x00], 0x1000);
    cpu.reset();
...
fn test_sbc_overflow() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xE9, 0b0000_0010, 0x00], 0x1000);
    cpu.reset();
    cpu.set_flag(Flags::Carry);
    cpu.register_a = 0x01;
    cpu.run();
...
fn test_sbc_sub_zero() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xE9, 0x00, 0x00], 0x1000);
    cpu.reset();
    cpu.set_flag(Flags::Carry);
    cpu.register_a = 0x01;
    cpu.run();
...
fn test_stx_zero_page_y() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x96, 0x24, 0x00], 0x1000);
    cpu.reset();
    cpu.register_y = 0x53;
    cpu.register_x = 0xFE;
    cpu.run();
...
fn test_sty_zero_page_x() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x94, 0x24, 0x00], 0x1000);
    cpu.reset();
    cpu.register_x = 0x53;
    cpu.register_y = 0xFE;
    cpu.run();
...
fn test_ora_neg_indirect_y() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x11, 0x10, 0x00], 0x1000);
    cpu.reset();
...
fn test_ora_neg_indirect_x() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x01, 0x10, 0x00], 0x1000);
    cpu.reset();
    cpu.register_x = 0x20;
...
fn test_ora_neg_absolute_y() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x19, 0x10, 0x12, 0x00], 0x1000);
    cpu.reset();
    cpu.register_y = 0x35;
...
fn test_lax() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xA7, 0x10, 0x00], 0x1000);
    cpu.reset();
...
fn test_sax() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x87, 0x10, 0x00], 0x1000);
    cpu.reset();
...
fn test_sbc2_sub_zero() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xEB, 0x00, 0x00], 0x1000);
    cpu.reset();
    cpu.set_flag(Flags::Carry);
    cpu.register_a = 0x01;
    cpu.run();
...
fn test_dcp() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xC7, 0x10, 0x00], 0x1000);
    cpu.reset();
...
fn test_isb() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xE7, 0x10, 0x00], 0x1000);
    cpu.reset();
    cpu.mem_write(0x10, 0x05);
    cpu.register_a = 0x15;
    cpu.run();
...
fn test_slo() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x07, 0x10, 0x00], 0x1000);
    cpu.reset();
...
fn test_rla() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x27, 0x10, 0x00], 0x1000);
    cpu.reset();
    cpu.mem_write(0x10, 0b0001_0010);
    cpu.register_a = 0b0010_1000;
    cpu.set_flag(Flags::Carry);
...
fn test_sre() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x47, 0x10, 0x00], 0x1000);
    cpu.reset();
    cpu.mem_write(0x10, 0b0001_0010);
    cpu.register_a = 0b0010_1000;
    cpu.run();
...
fn test_rra() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x67, 0x10, 0x00], 0x1000);
    cpu.reset();
    cpu.mem_write(0x10, 0b0001_0010);
    cpu.register_a = 0b0010_1000;
    cpu.run();
...
fn test_xaa() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x8B, 0b1110_1100, 0x00], 0x1000);
    cpu.reset();
    cpu.register_x = 0xFA;
    cpu.register_a = 0b1011_1000;
    cpu.run();
...
#[test]
fn test_axa() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x0500));
    cpu.load(&[0x9F, 0x00, 0x10, 0x00], 0x0500);
    cpu.reset();
...
fn test_xas() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0x9B, 0x10, 0x00, 0x00], 0x1000);
    cpu.reset();
...
fn test_sya() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x0500));
    cpu.load(&[0x9C, 0x00, 0x10, 0x00], 0x0500);
    cpu.reset();
    cpu.register_x = 0x01;
...
fn test_sxa() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x0500));
    cpu.load(&[0x9E, 0x00, 0x10, 0x00], 0x0500);
    cpu.reset();
    cpu.register_y = 0x01;
...
fn test_axt() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xAB, 0xCB, 0x00], 0x1000);
    cpu.reset();
    cpu.register_a = 0x01;
    cpu.register_x = 0b0001_0001;
    cpu.run();
...
fn test_lar() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xBB, 0x20, 0x00, 0x00], 0x1000);
    cpu.reset();
...
fn test_axs() {
    let mut cpu = CPU::new(Rom::new_blank_test_rom(0x1000));
    cpu.load(&[0xCB, 0x02, 0x00], 0x1000);
    cpu.reset();
